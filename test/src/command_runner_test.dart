...
void main() {
  group('DartMentCommandRunner', () {
    ...
    setUp(() {
      ...
      commandRunner = DartMentCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = DartMentCommandRunner();
    ...
    group('--verbose', () {
      ...
      test('enables verbose logging for sub commands', () async {
        ...
        verify(() => logger.detail('    - suggestions: false')).called(1);
      });
    });
  });
}
